 ...
 * 
 */
public class CCShxFile extends CCShapeFileReader {
	...
	public CCShxFile(CCShapeFile theParentShapeFile, File theFile) {
		super(theParentShapeFile, theFile);
	}
	...
	public CCShapeFileHeader getHeader() {
		return header;
	}
